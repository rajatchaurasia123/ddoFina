...
const ResourceCostForecastBreakdownByMonth = sequelize.define('ResourceCostForecastBreakdownByMonth', {
  id: {
  ...
  tableName: 'ResourceCostForecastBreakdownByMonth',
...
module.exports = {
  ResourceCostForecastBreakdownByMonth,
  sequelize, 
};
