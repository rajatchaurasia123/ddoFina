// models/ForecastedCollectionBreakdownByMonth.js
const { DataTypes } = require('sequelize');
const { sequelize } = require('../../config/db');  // Adjust the path based on your project structure
const ForecastedCollectionBreakdownByMonth = sequelize.define('ForecastedCollectionBreakdownByMonth', {
  id: {
  ...
  tableName: 'ForecastedCollectionBreakdownByMonth',
  timestamps: false,
});
